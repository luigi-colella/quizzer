...
/* harmony import */ var _components_quiz_runner_quiz_runner_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/quiz-runner/quiz-runner.module */ "./src/app/components/quiz-runner/quiz-runner.module.ts");
/* harmony import */ var _components_quiz_creator_quiz_creator_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/quiz-creator/quiz-creator.module */ "./src/app/components/quiz-creator/quiz-creator.module.ts");
...
/* harmony import */ var _services_quiz_handler_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/quiz-handler.service */ "./src/app/services/quiz-handler.service.ts");
/* harmony import */ var _services_fileLoader_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/fileLoader.service */ "./src/app/services/fileLoader.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _components_header_header_component__WEBPACK_IMPORTED_MODULE_4__["AppHeader"],
                _app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"]
            ],
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
                _components_quiz_runner_quiz_runner_module__WEBPACK_IMPORTED_MODULE_2__["QuizRunnerModule"],
                _components_quiz_creator_quiz_creator_module__WEBPACK_IMPORTED_MODULE_3__["QuizCreatorModule"],
                _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"]
            ],
            providers: [
                _services_quiz_handler_service__WEBPACK_IMPORTED_MODULE_7__["QuizHandler"],
                _services_fileLoader_service__WEBPACK_IMPORTED_MODULE_8__["FileLoader"]
            ],
...
/* harmony import */ var _interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../interfaces/quizTypes */ "./src/app/interfaces/quizTypes.ts");
/* harmony import */ var _services_fileLoader_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/fileLoader.service */ "./src/app/services/fileLoader.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QuizCreatorComponent = /** @class */ (function () {
    function QuizCreatorComponent(ngFormBuilder, fileLoader) {
        var _this = this;
        this.ngFormBuilder = ngFormBuilder;
        this.fileLoader = fileLoader;
        //Object of quiz types for template;
        this.quizTypes = {
            'trueorfalseQuiz': _interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_2__["TRUEORFALSE_QUIZ"],
            'personalityQuiz': _interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_2__["PERSONALITY_QUIZ"]
        };
        ...
        this.quizValidators = {
            ...
            validQuizType: function () {
                return function (control) {
                    var valid = control.value === _interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_2__["PERSONALITY_QUIZ"] || control.value === _interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_2__["TRUEORFALSE_QUIZ"];
            ...
            validAnswerValue: function () {
                return function (control) {
                    ...
                    var inputValue = control.value;
                    if (quizType === _interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_2__["PERSONALITY_QUIZ"]) {
                        return typeof inputValue === 'string' && inputValue.trim() === '' ? { 'validAnswerValue': { text: 'testo vuoto' } } : null;
                    }
                    else if (quizType === _interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_2__["TRUEORFALSE_QUIZ"]) {
        ...
        this.quizBuilders = (function () {
            ...
            var emptyQuestion = function () {
                return _this.ngFormBuilder.group({
                    text: ['', _this.quizValidators.validText()],
                    answers: _this.ngFormBuilder.array([emptyAnswer()], _this.quizValidators.validItems())
                });
            };
        ...
        this.handleAnswers = {
            addNew: function () {
                var answers = _this.quiz.get('answers');
                answers.push(_this.quizBuilders.emptyResult());
            },
        ...
        this.handleAnswersValue = {
            ...
            updateValues: function () {
                ...
                var allQuestions = _this.quiz.get('questions').value;
                if (allQuestions.length > 0) {
                    result = allQuestions.reduce(function (prevValue, currQuestion) {
                        return prevValue.concat(currQuestion.answers
                            .map(function (answer) { return answer.value; })
                            .filter(function (answerValue) { return typeof answerValue === 'string' && answerValue.trim() !== ''; }));
                    }, []);
                }
                ;
                //Get all possibilies values from answers
                var allAnswers = _this.quiz.get('answers').value;
                if (allAnswers.length > 0) {
                    result = result.concat(allAnswers
                        .map(function (currAnswer) { return currAnswer.value; })
                        .filter(function (value) { return typeof value === 'string' && value.trim() !== ''; }));
                }
                ;
                //Update values
                _this.handleAnswersValue._allAnswersValues = result;
            },
            //Get suggested values
            updateSuggestedValues: function (inputedValue) {
                //Update all possibilies values
                _this.handleAnswersValue.updateValues();
                //Filter all possibilities values
                _this.handleAnswersValue.suggestedValues = _this.handleAnswersValue._allAnswersValues.filter(function (possibleValue) {
                    return (possibleValue.toLowerCase().indexOf(inputedValue.toLowerCase()) === 0 &&
        ...
        this.onChangeQuizType = function () {
            ...
            questionsControls.forEach(function (form) {
                ...
                answersControls.forEach(function (form) {
                    ...
                    if ((quizType === _interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_2__["PERSONALITY_QUIZ"] && typeof valueControl.value === 'boolean') ||
                        (quizType === _interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_2__["TRUEORFALSE_QUIZ"] && valueControl.value.trim && valueControl.value.trim() !== ''))
    ...
    QuizCreatorComponent.prototype.onSubmit = function () {
        ...
        var encodedJSON = this.fileLoader.encode(this.quiz.value);
    ...
    QuizCreatorComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
            _services_fileLoader_service__WEBPACK_IMPORTED_MODULE_3__["FileLoader"]])
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_quiz_handler_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/quiz-handler.service */ "./src/app/services/quiz-handler.service.ts");
/* harmony import */ var _services_fileLoader_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/fileLoader.service */ "./src/app/services/fileLoader.service.ts");
/* harmony import */ var _mocks_quiz_music__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../mocks/quiz.music */ "./src/app/mocks/quiz.music.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QuizRunnerComponent = /** @class */ (function () {
    function QuizRunnerComponent(handler, fileLoader) {
        this.handler = handler;
        this.fileLoader = fileLoader;
        this.submitButtonIsDisabled = false;
    }
    QuizRunnerComponent.prototype.ngOnInit = function () {
        this.loadQuiz(this.handler.load(_mocks_quiz_music__WEBPACK_IMPORTED_MODULE_3__["quizMusic"]).getQuizObject());
    };
    QuizRunnerComponent.prototype.uploadQuiz = function (event) {
        ...
        if (uploadedFiles.length === 1) {
            ...
            reader.onload = function (event) {
                var quiz = _this.fileLoader.decode(event.target.result);
                _this.loadQuiz(quiz);
            };
            // Start reader
    ...
    QuizRunnerComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_quiz_handler_service__WEBPACK_IMPORTED_MODULE_1__["QuizHandler"],
            _services_fileLoader_service__WEBPACK_IMPORTED_MODULE_2__["FileLoader"]])
    ], QuizRunnerComponent);
...
/***/ "./src/app/interfaces/quizTypes.ts":
/*!*****************************************!*\
  !*** ./src/app/interfaces/quizTypes.ts ***!
  \*****************************************/
/*! exports provided: PERSONALITY_QUIZ, TRUEORFALSE_QUIZ */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/app/services/fileLoader.service.ts":
/*!************************************************!*\
  !*** ./src/app/services/fileLoader.service.ts ***!
  \************************************************/
...
var FileLoader = /** @class */ (function () {
    ...
    FileLoader.prototype.encode = function (data) {
        return this.encodingDeclaration + encodeURIComponent(JSON.stringify(data));
    };
    FileLoader.prototype.decode = function (string) {
...
/***/ "./src/app/services/quiz-handler.service.ts":
/*!**************************************************!*\
  !*** ./src/app/services/quiz-handler.service.ts ***!
  \**************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../interfaces/quizTypes */ "./src/app/interfaces/quizTypes.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var QuizHandler = /** @class */ (function () {
    ...
    QuizHandler.prototype.getResult = function (answers) {
        ...
        switch (this.currentQuiz.settings.type) {
            case (_interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_1__["PERSONALITY_QUIZ"]):
                ...
                break;
            case (_interfaces_quizTypes__WEBPACK_IMPORTED_MODULE_1__["TRUEORFALSE_QUIZ"]):
